...
Author: Nicholas Fay, nfay@uoregon.edu ID:951566471
01/30/2018
worked with Ryan G, Remy R.
"""
import numbers
import logging
logging.basicConfig
...
class BinOp(Expr):
    """Abstract superclass for binary expressions like plus, minus, Times and Div"""
    ...
    def eval(self):
        ...
        lval = self.left.eval() #defines left value
        rval = self.right.eval() #defines right value
